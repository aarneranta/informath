...
Definition. Let $n$ and $k$ be instances of natural numbers. Then the binomial coefficient of $n$ and $k$ is an instance of natural numbers defined as the function that maps $n$ and $k$ to the quotient of the factorial of $n$ and the product of the factorial of $k$ and the factorial of the difference of $n$ and $k$.

Definition. Let $n$ and $k$ be natural numbers. Then the binomial coefficient of $n$ and $k$ is a natural number defined as the function that maps $n$ and $k$ to the quotient of the factorial of $n$ and the product of the factorial of $k$ and the factorial of the difference of $n$ and $k$.

Definition. Let $n , k \in N$. Then the binomial coefficient of $n$ and $k$ is a natural number defined as the function that maps $n$ and $k$ to the quotient of the factorial of $n$ and the product of the factorial of $k$ and the factorial of the difference of $n$ and $k$.

Definition. Let $n$ and $k$ be natural numbers. Then $\binom{ n }{ k}$ is a natural number defined as the function that maps $n$ and $k$ to $\frac{ n !}{k ! (n - k)!}$.

Definition. Let $n , k \in N$. Then $\binom{ n }{ k}$ is a natural number defined as the function that maps $n$ and $k$ to $\frac{ n !}{k ! (n - k)!}$.
